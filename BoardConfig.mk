...
BOARD_SUPER_PARTITION_GROUPS := vince_dynpart
BOARD_VINCE_DYNPART_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_VINCE_DYNPART_PARTITION_LIST := odm product system system_ext vendor
